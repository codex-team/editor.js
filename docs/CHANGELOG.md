...
- `Improvements` - API: If `blocks.delete` method called, but no Block selected, show warning instead of throwing an error [#1102](https://github.com/codex-team/editor.js/issues/1102)
