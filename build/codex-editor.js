  ...
  module.exports = function (notifications) {
    ...
    notifications.errorThrown = function (errorMsg, event) {
      editor.notifications.notification({
        message: 'This action is not available currently',
        type: event.type
      });
    };
    /**
    ...
    (0, _createClass2.default)(BlockSelection, [{
      ...
      value: function prepare() {
        ...
        var _this$Editor = this.Editor,
            ...
            Listener = _this$Editor.Listener;
        /** Selection shortcut */
        ...
        observer.observe(overlayRectangle); // activates scrolling if blockSelection is active and mouse is in scroll zone
      ...
      value: function handleCommandC(event) {
        ...
        var _this$Editor2 = this.Editor,
            ...
            Sanitizer = _this$Editor2.Sanitizer;
...
/* WEBPACK VAR INJECTION */(function(Module, _) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var Paragraph = __webpack_require__(/*! ../tools/paragraph/dist/bundle */ "./src/components/tools/paragraph/dist/bundle.js");
  /**
