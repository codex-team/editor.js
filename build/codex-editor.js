            ...
            if (toolPasteConfig.handler && typeof toolPasteConfig.handler !== 'function') {
                ...
                tags.forEach(function (tag) {
                    if (_this.toolsTags.hasOwnProperty(tag)) {
                        _.log('Paste handler for \xAB' + name + '\xBB Tool on \xAB' + tag + '\xBB tag is skipped ' + ('because it is already used by \xAB' + _this.toolsTags[tag].tool + '\xBB Tool.'), 'warn');
                        return;
                    }
                    _this.toolsTags[tag] = {
            ...
            var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _this$Editor = _this.Editor, Tools = _this$Editor.Tools, Sanitizer = _this$Editor.Sanitizer, BlockManager = _this$Editor.BlockManager, Caret = _this$Editor.Caret;
...
!function (t, e) {
  ...
  return function (t) {
    ...
    function n(r) {
      ...
      if(1&e&&(t=n(t)), 8&e)return t;if(4&e&&'object'==typeof t&&t&&t.__esModule)return t;var r=Object.create(null);
 ...
 */
    var o=function () {
      function t(e) {
        var n=e.data, r=(e.config, e.api);

        !function (t, e) {
          if(!(t instanceof e))throw new TypeError('Cannot call a class as a function');
        }(this, t), this.api=r, this._CSS={block:this.api.styles.block, wrapper:'ce-paragraph'}, this._data={}, this._element=this.drawView(), this.data=n;
      }return r(t, null, [ {key:'displayInToolbox', get:function () {
        return!1;
      }} ]), r(t, [ {key:'drawView', value:function () {
      ...
      }} ], [ {key:'onPaste', get:function () {
        return{tags:[ 'P' ], handler:function (t) {
          return{text:t.innerHTML};
        }};
      }} ]), t;
    }();
    ...
    'string'==typeof r&&(r=[ [t.i, r, ''] ]);var o={hmr:!0, transform:void 0, insertInto:void 0};
      ...
      return e.toString=function () {
        return this.map(function (e) {
          var n=function (t, e) {
            ...
            if(!r)return n;if(e&&'function'==typeof btoa) {
              var o=function (t) {
    ...
    function c(t, e) {
      for(var n=0;n<t.length;n++) {
        ...
        if(i) {
          i.refs++;for(var a=0;a<i.parts.length;a++)i.parts[a](o.parts[a]);for(;a<o.parts.length;a++)i.parts.push(b(o.parts[a], e));
        }else{
          var s=[];

          for(a=0;a<o.parts.length;a++)s.push(b(o.parts[a], e));r[o.id]={id:o.id, refs:1, parts:s};
        }
      }
    }function l(t, e) {
      ...
      if(!n)throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");var r=u[u.length-1];
      ...
      if(null===t.parentNode)return!1;t.parentNode.removeChild(t);var e=u.indexOf(t);
      ...
      if(e.transform&&t.css) {
        ...
        n=a||(a=h(e)), r=m.bind(null, n, u, !1), o=m.bind(null, n, u, !0);
        ...
        (e.convertToAbsoluteUrls||i)&&(r=f(r));o&&(r+='\n/*# sourceMappingURL=data:application/json;base64,'+btoa(unescape(encodeURIComponent(JSON.stringify(o))))+' */');var a=new Blob([ r ], {type:'text/css'}), s=t.href;
        ...
        r&&t.setAttribute('media', r);if(t.styleSheet)t.styleSheet.cssText=n;else{
      ...
      if('undefined'!=typeof DEBUG&&DEBUG&&'object'!=typeof document)throw new Error('The style-loader cannot be used in a non-browser environment');(e=e||{}).attrs='object'==typeof e.attrs?e.attrs:{}, e.singleton||'boolean'==typeof e.singleton||(e.singleton=o()), e.insertInto||(e.insertInto='head'), e.insertAt||(e.insertAt='bottom');var n=l(t, e);
      ...
      return c(n, e), function (t) {
        ...
        }t&&c(l(t, e), e);for(i=0;i<o.length;i++) {
          var s;

          if(0===(s=o[i]).refs) {
            for(var u=0;u<s.parts.length;u++)s.parts[u]();delete r[s.id];
          }
        }
      };
    };var y=function () {
    ...
    t.exports=function (t) {
      ...
      if(!e)throw new Error('fixUrls requires window.location');if(!t||'string'!=typeof t)return t;var n=e.protocol+'//'+e.host, r=n+e.pathname.replace(/\/[^\/]*$/, '/');
