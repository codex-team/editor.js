    ...
    (0, _createClass2.default)(Paste, [{
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee8(dataToInsert) {
          var initialTool, _this$Editor4, BlockManager, Caret, Sanitizer, Tools, content, tool, blockData, insertedBlock, needToReplaceCurrentBlock, currentToolSanitizeConfig;

          return _regenerator.default.wrap(function _callee8$(_context8) {
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  initialTool = this.config.initialBlock, _this$Editor4 = this.Editor, BlockManager = _this$Editor4.BlockManager, Caret = _this$Editor4.Caret, Sanitizer = _this$Editor4.Sanitizer, Tools = _this$Editor4.Tools, content = dataToInsert.content, tool = dataToInsert.tool;
