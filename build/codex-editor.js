...
/*!**********************************************************************************************!*\
  !*** /Users/talyguryn/GitHub/codex.notes/node_modules/@codexteam/shortcuts/lib/shortcuts.js ***!
  \**********************************************************************************************/
    ...
    _createClass(BlockEvents, [{
        ...
        value: function enter(event) {
            var currentBlock = this.Editor.BlockManager.currentBlock,
                toolSetting = this.Editor.Tools.getToolSettings(currentBlock.name);
            /**
             * Don't handle Enter keydowns when Tool sets enableLineBreaks to true.
             * Uses for Tools like <code> where line breaks should be handled by default behaviour.
             */
            if (toolSetting && toolSetting[this.Editor.Tools.apiSettings.IS_ENABLED_LINE_BREAKS]) {
                return;
            }
            /**
