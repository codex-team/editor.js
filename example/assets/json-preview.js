...
const cPreview = (function (module) {
  ...
  function stylize(string) {
    ...
    /** Stylize tool names */
    string = string.replace( /"(paragraph|quote|list|header|link|code|image|delimiter|raw|checklist|table|embed|warning|personality|attaches)"/g, '"<span class=sc_toolname>$1</span>"');
    /** Stylize HTML tags */
