...
export default class Toolbar extends Module {
  ...
  move(forceClose = true) {
     ...
     */
    this.nodes.plusButton.style.transform = `translate3d(0, calc(${Math.floor(currentBlock.offsetHeight / 2)}px - 50%), 0)`;
    this.Editor.Toolbox.nodes.toolbox.style.transform = `translate3d(0, calc(${Math.floor(currentBlock.offsetHeight / 2)}px - 50%), 0)`;
    /**
