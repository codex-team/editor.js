  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockEvents, [{
      ...
      value: function enter(event) {
        ...
        if (tool && tool[Tools.INTERNAL_SETTINGS.IS_ENABLED_LINE_BREAKS] && !BlockSettings.opened && !InlineToolbar.opened && !ConversionToolbar.opened) {
          return;
        }
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockSelection, [{
      ...
      value: function clearSelection(reason) {
        ...
        this.Editor.CrossBlockSelection.clear(reason); // if (!this.anyBlockSelected || RectangleSelection.isRectActivated()) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"), __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/getPrototypeOf.js"), __webpack_require__(/*! @babel/runtime/helpers/inherits */ "./node_modules/@babel/runtime/helpers/inherits.js"), __webpack_require__(/*! ../__module */ "./src/components/__module.ts"), __webpack_require__(/*! ../block */ "./src/components/block.ts"), __webpack_require__(/*! ../selection */ "./src/components/selection.ts"), __webpack_require__(/*! ../utils */ "./src/components/utils.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _block, _selection, _utils) {
  "use strict";
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(CrossBlockSelection, [{
      ...
      value: function watchSelection(event) {
        ...
        if (!event.target.closest(".".concat(_block.default.CSS.content))) {
          return;
        }
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"), __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/getPrototypeOf.js"), __webpack_require__(/*! @babel/runtime/helpers/inherits */ "./node_modules/@babel/runtime/helpers/inherits.js"), __webpack_require__(/*! ../__module */ "./src/components/__module.ts"), __webpack_require__(/*! ../dom */ "./src/components/dom.ts"), __webpack_require__(/*! ../utils */ "./src/components/utils.ts"), __webpack_require__(/*! ../block */ "./src/components/block.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _dom, _utils, _block) {
  "use strict";
  ...
  function (_Module) {
    ...
    function RectangleSelection() {
      ...
      _this.startSelection = function (event) {
        if (event.button !== _utils.default.mouseButtons.LEFT) {
          return;
        }
        ...
        _this.startX = _this.mouseX = event.pageX - window.pageXOffset;
        _this.startY = _this.mouseY = event.pageY - window.pageYOffset;
        _this.rectangle.style.left = "".concat(_this.startX, "px");
        _this.rectangle.style.top = "".concat(_this.startY, "px");
      };

      _this.changeRectangle = function (event) {
        if (!_this.mousedown) {
          return;
        }

        _this.mouseX = event.pageX - window.pageXOffset;
        _this.mouseY = event.pageY - window.pageYOffset;
        var width = Math.abs(_this.mouseX - _this.startX);
        var height = Math.abs(_this.mouseY - _this.startY);

        if (_this.mouseX < _this.startX) {
          _this.rectangle.style.left = "".concat(_this.mouseX, "px");
        }

        if (_this.mouseY < _this.startY) {
          _this.rectangle.style.top = "".concat(_this.mouseY, "px");
        }

        _this.rectangle.style.width = "".concat(width, "px");
        _this.rectangle.style.height = "".concat(height, "px");
      };

      _this.endSelection = function () {
        _this.mousedown = false;
        _this.startX = _this.mouseX = 0;
        _this.startY = _this.mouseY = 0;
        _this.rectangle.style.width = _this.rectangle.style.height = '0';
      }; // /**
      //  * Init rect params
    ...
    (0, _createClass2.default)(RectangleSelection, [{
      ...
      value: function prepare() {
        var _this$Editor = this.Editor,
            Listeners = _this$Editor.Listeners,
            UI = _this$Editor.UI;
        var wrapper = UI.nodes.wrapper;
        this.prepareUI();
        Listeners.on(wrapper, 'mousedown', this.startSelection, false);
        Listeners.on(document.body, 'mousemove', this.changeRectangle, false);
        Listeners.on(document.body, 'mouseup', this.endSelection, false);
        Listeners.on(document.body, 'mouseleave', this.endSelection, false); // Listeners.on(container, 'mousedown', (event: MouseEvent) => {
      ...
      value: function prepareUI() {
        ...
        var rectContainer = _dom.default.make('div', RectangleSelection.CSS.overlayContainer, {});

        var rectangle = _dom.default.make('div', RectangleSelection.CSS.rect, {});

        overlay.appendChild(rectContainer);
        rectContainer.appendChild(rectangle);
        this.Editor.UI.nodes.wrapper.appendChild(overlay);
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.16.0");
