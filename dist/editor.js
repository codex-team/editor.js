...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function () {
    ...
    (0, _createClass2.default)(Dom, null, [{
      ...
      value: function leafNodesAndReturnIndex(nodeList, activeIndex, direction) {
        var activeCSSClass = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'cdx-settings-button--focused';
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockEvents, [{
      ...
      value: function tabPressed(event) {
        ...
        } else if (!currentBlock.isEmpty && _selection.default.isTextSelected) {
          /**
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockSettings, [{
      ...
      value: function leaf() {
        ...
        this.activeButtonIndex = _dom.default.leafNodesAndReturnIndex(this.blockTunesButtons, this.activeButtonIndex, direction);
      }
      /**
       * @return {HTMLElement}
       */
    ...
    (0, _createClass2.default)(InlineToolbar, [{
      ...
      value: function leaf() {
        ...
        this.buttonsList.forEach(function (tool) {
          if (!tool.hidden) {
            _this3.visibleButtonsList.push(tool);
          }
        });
        this.activeButtonIndex = _dom.default.leafNodesAndReturnIndex(this.visibleButtonsList, this.activeButtonIndex, direction, this.CSS.activeButton);
      }
      /**
      ...
      value: function dropActiveButtonIndex() {
        this.visibleButtonsList[this.activeButtonIndex].classList.remove(this.CSS.activeButton);
        this.activeButtonIndex = -1;
      }
      /**
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Toolbox, [{
      ...
      value: function close() {
        ...
        if (this.activeButtonIndex !== -1) {
          this.nodes.toolbox.childNodes[this.activeButtonIndex].classList.remove(this.CSS.activeButton);
          this.activeButtonIndex = -1;
        }
      }
      /**
      ...
      value: function leaf() {
        ...
        this.activeButtonIndex = _dom.default.leafNodesAndReturnIndex(childNodes, this.activeButtonIndex, direction, this.CSS.activeButton);
      }
      /**
    ...
    (0, _createClass2.default)(UI, [{
      ...
      value: function enterPressed(event) {
        ...
        if (this.Editor.BlockSettings.opened && this.Editor.BlockSettings.getActiveButton) {
          ...
          BlockManager.currentBlock.pluginsContent.focus();
          return;
        }
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.13.0");
