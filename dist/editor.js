...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockSettings, [{
      ...
      value: function blockTunesButtons() {
        var _this2 = this;
      ...
      value: function leaf() {
        ...
        var buttonsList = this.blockTunesButtons();
        this.activeButtonIndex = _dom.default.leafNodes(buttonsList, this.activeButtonIndex, direction);
      }
      /**
       * @return {HTMLElement}
       */
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(UI, [{
      ...
      value: function documentClicked(event) {
        ...
        var clickedInsideOfEditor = !!target.closest("#".concat(this.config.holderId)) || _selection.default.isAtEditor;
