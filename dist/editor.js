...
var map = {
	...
	"./mouseSelection": "./src/components/modules/mouseSelection.ts",
	"./mouseSelection.ts": "./src/components/modules/mouseSelection.ts",
    ...
    (0, _createClass2.default)(BlockEvents, [{
      ...
      value: function mouseUp(event) {
        var _this$Editor = this.Editor,
            ...
            UI = _this$Editor.UI;
        var mouseMoveListener = Listeners.findOne(UI.nodes.redactor, 'mousemove');
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockSelection, [{
      ...
      value: function clearSelection() {
        ...
        var _this$Editor = this.Editor,
            MouseSelection = _this$Editor.MouseSelection,
...
/***/ "./src/components/modules/mouseSelection.ts":
/*!**************************************************!*\
  !*** ./src/components/modules/mouseSelection.ts ***!
  \**************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  /*#__PURE__*/
  function (_Module) {
    (0, _inherits2.default)(MouseSelection, _Module);

    function MouseSelection() {
      var _this;

      (0, _classCallCheck2.default)(this, MouseSelection);
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(MouseSelection).apply(this, arguments));
      _this.isMouseSelectionActivated = false;
      _this.isDownDirection = undefined;

      _this.onMouseUp = function () {
        var Listeners = _this.Editor.Listeners;
        Listeners.off(document, 'mousemove', _this.onMouseMove);
      ...
      _this.onMouseMove = function (event) {
        ...
        var targetBlockIndex = BlockManager.blocks.indexOf(targetBlock);

        if (_this.lastSelectedBlockIndex === targetBlockIndex) {
          return;
        }

        if (targetBlockIndex === _this.firstSelectedBlockIndex) {
          _this.isDownDirection = undefined;
          _this.firstSelectedBlock.selected = false;
          BlockManager.getBlockByIndex(_this.lastSelectedBlockIndex).selected = false;
          _this.lastSelectedBlockIndex = _this.firstSelectedBlockIndex;
          _this.isMouseSelectionActivated = false;
          return;
        }

        if (_this.isDownDirection === undefined) {
          _this.isDownDirection = targetBlockIndex > _this.firstSelectedBlockIndex;
          _this.firstSelectedBlock.selected = true;

          var nativeSelection = _selection.default.get();

          nativeSelection.empty();
          _this.isMouseSelectionActivated = true;
        }

        if (_this.isDownDirection) {
          if (targetBlockIndex > _this.lastSelectedBlockIndex) {
            targetBlock.selected = true;
          } else if (targetBlockIndex < _this.lastSelectedBlockIndex) {
            BlockManager.getBlockByIndex(_this.lastSelectedBlockIndex).selected = false;
          }
        } else {
          if (targetBlockIndex < _this.lastSelectedBlockIndex) {
        ...
        _this.lastSelectedBlockIndex = targetBlockIndex;
      };

      return _this;
    }

    (0, _createClass2.default)(MouseSelection, [{
      key: "watchSelection",
      value: function watchSelection(event) {
        var _this$Editor = this.Editor,
            ...
            UI = _this$Editor.UI,
            Listeners = _this$Editor.Listeners;
        this.firstSelectedBlock = BlockManager.currentBlock || BlockManager.getBlockByChildNode(event.target);
  ...
  _exports.default = MouseSelection;
    ...
    (0, _createClass2.default)(InlineToolbar, [{
      ...
      value: function make() {
        ...
        this.Editor.Listeners.on(this.nodes.wrapper, 'mousedown', function (event) {
          var isClickedOnActionsWrapper = event.target.closest(".".concat(_this2.CSS.actionsWrapper));
          /**
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Tools, [{
      ...
      value: function prepare() {
        ...
        _utils.default.deepMerge(this.config.tools, this.internalTools);
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.12.4");
