      ...
      value: function keyup(event) {
        ...
        if (!currentBlock) {
          try {
            ...
            _utils.default.log(e);

            return;
          }
        }

        var isHandledOnKeyDown = false;
    ...
    (0, _createClass2.default)(ConversionToolbar, [{
      ...
      value: function handleShowingEvent(event) {
        ...
        if (this.tools[currentToolName]) {
          ...
          Array.from(this.nodes.tools.childNodes).forEach(function (tool, index) {
