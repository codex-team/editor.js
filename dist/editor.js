  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(ConversionToolbar, [{
      ...
      value: function leaf() {
        ...
        this.focusedButtonIndex = _dom.default.leafNodesAndReturnIndex(toolsElements, this.focusedButtonIndex, direction, ConversionToolbar.CSS.conversionToolActive);
      }
      /**
       * @return {HTMLElement}
       */
      ...
      value: function dropFocusedButton() {
        ...
        var tool = this.nodes.tools.childNodes[this.focusedButtonIndex];
      ...
      key: "move",
      value: function move() {
        var targetBlock = this.Editor.BlockManager.currentBlock.pluginsContent;
        var targetBlockCoords = targetBlock.getBoundingClientRect();
      ...
      value: function addTool(toolName, toolIcon) {
        ...
        function () {
          ...
          /*#__PURE__*/
          _regenerator.default.mark(function _callee(event) {
            var currentBlockToolClass, savedBlock, blockData, replacingTool, newBlockData;
            return _regenerator.default.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    currentBlockToolClass = _this2.Editor.BlockManager.currentBlock.class;
                    _context.next = 3;
                    return _this2.Editor.BlockManager.currentBlock.save();

                  case 3:
                    savedBlock = _context.sent;
                    blockData = savedBlock.data;
                    replacingTool = _this2.Editor.Tools.toolsClasses[toolName];
                    newBlockData = {};
                    newBlockData[replacingTool.conversionConfig.export] = _this2.Editor.Sanitizer.clean(blockData[currentBlockToolClass.conversionConfig.import], replacingTool.sanitize);

                    _this2.Editor.BlockManager.replace(toolName, newBlockData);
