...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function () {
    ...
    (0, _createClass2.default)(Flipper, [{
      ...
      value: function handleEnterPress(event) {
        ...
        if (this.callbacks && _utils.default.typeof(this.callbacks.onEnterPress) === 'function') {
  ...
  function () {
    ...
    (0, _createClass2.default)(FlipperIterator, [{
      ...
      value: function leafNodesAndReturnIndex(activeIndex, direction) {
        /**
        ...
        if (_dom.default.isNativeInput(this.items[activeIndex])) {
          /**
           * Focus input
           */
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Toolbox, [{
      ...
      value: function enableFlipper() {
        ...
        this.flipper = new _flipper.default(tools, this.CSS.toolboxButtonActive);
      }
      /**
       * Inserts new block
