  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockEvents, [{
      ...
      value: function keyup(event) {
        if (_selection.default.almostAllSelected(event.target.textContent)) {
          this.Editor.InlineToolbar.close();
    ...
    (0, _createClass2.default)(ConversionToolbar, [{
      ...
      value: function handleShowingEvent(event) {
        ...
        if (force && !currentBlock) {
          currentBlock = this.Editor.BlockManager.getBlock(_selection.default.get().anchorNode);
        ...
        if (this.tools[currentToolName]) {
          ...
          this.nodes.tools.childNodes.forEach(function (tool, index) {
            if (tool.classList.contains(ConversionToolbar.CSS.conversionToolActive)) {
              _this2.focusedButtonIndex = index;
            }
          });
        }
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function () {
    ...
    (0, _createClass2.default)(SelectionUtils, [{
      ...
      /**
       * Returns true if 95% of text content is selected
       * @return {boolean}
       */
