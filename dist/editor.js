...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function (_Module) {
    ...
    function BlockSelection() {
      ...
      _this.shouldClearOnMouseUp = true;
      /**
  ...
  function (_Module) {
    ...
    function MouseSelection() {
      ...
      _this.onMouseOver = function (event) {
        ...
        var relatedBlock = BlockManager.getBlockByChildNode(event.relatedTarget);
        ...
        _this.lastSelectedBlockIndex = BlockManager.blocks.indexOf(targetBlock);
        ...
        _this.changeBlocksState(relatedBlock, targetBlock);
      };
    ...
    (0, _createClass2.default)(MouseSelection, [{
      ...
      value: function watchSelection(event) {
        var _this$Editor2 = this.Editor,
            ...
            UI = _this$Editor2.UI,
            Listeners = _this$Editor2.Listeners;
        this.firstSelectedBlock = this.lastSelectedBlock = BlockManager.getBlockByChildNode(event.target);
      ...
      key: "changeBlocksState",
      value: function changeBlocksState(firstBlock, lastBlock) {
        var BlockManager = this.Editor.BlockManager;
