  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(ConversionToolbar, [{
      ...
      value: function handleShowingEvent(event) {
        ...
        var currentToolName = BlockManager.currentBlock.name;
      ...
      value: function dropFocusedButton() {
        ...
        Object.values(this.nodes.tools.childNodes).forEach(function (tool) {
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee(replacingToolName) {
          ...
          var currentBlockClass, savedBlock, blockData, replacingTool, newBlockData, exportProp, exportData, cleaned;
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                ...
                case 3:
                  ...
                  newBlockData = {};
                  exportProp = replacingTool.conversionConfig.export;
                  exportData = '';
                  ...
                  cleaned = this.Editor.Sanitizer.clean(exportData, replacingTool.sanitize); // newBlockData[replacingTool.conversionConfig.import] =
      ...
      value: function addTools() {
        ...
        for (var toolName in tools) {
          ...
          var hasImport = toolClass.conversionConfig.import;
          var hasExport = toolClass.conversionConfig.export;
