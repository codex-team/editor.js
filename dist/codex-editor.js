...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function () {
     ...
     */
    function Block(toolName, toolInstance, toolClass, settings, tunes, apiMethods) {
    ...
    (0, _createClass2.default)(Block, [{
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee3() {
          ...
          var measuringStart, data, settings, measuringEnd;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 4:
                  data = _context3.sent;
                  _context3.next = 7;
                  return Object.entries(this.tunes).reduce(
                  /*#__PURE__*/
                  function () {
                    var _ref2 = (0, _asyncToGenerator2.default)(
                    /*#__PURE__*/
                    _regenerator.default.mark(function _callee2(result, _ref) {
                      var _ref3, name, tune, savedData;

                      return _regenerator.default.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              _ref3 = (0, _slicedToArray2.default)(_ref, 2), name = _ref3[0], tune = _ref3[1];
                              _context2.next = 3;
                              return _this.saveTuneState(tune);
                            ...
                            case 6:
                              return _context2.abrupt("return", Object.assign({}, result, (0, _defineProperty2.default)({}, name, savedData)));
                ...
                case 12:
                  ...
                  _utils.default.log("Saving proccess for ".concat(this.name, " tool failed due to the ").concat(_context3.t0), 'log', 'red');
      ...
      key: "makeTunes",
      value: function makeTunes(tunes) {
        var _this2 = this;

        var tunesList = Object.assign({
          MoveUpTune: _blockTuneMoveUp.default,
          DeleteTune: _blockTuneDelete.default,
          MoveDownTune: _blockTuneMoveDown.default
        }, tunes); // Pluck tunes list and return tune instances with passed Editor API and settings

        return Object.entries(tunesList).reduce(function (result, _ref4) {
          ...
          try {
            var tune = new Tune({
              api: _this2.api,
              settings: _this2.settings[name]
            });
            return Object.assign((0, _defineProperty2.default)({}, name, tune), result);
          } catch (e) {
            _utils.default.log("Tune \xAB".concat(name, "\xBB was skipped because of %o"), 'warn', e);
      ...
      value: function renderTunes() {
        ...
        Object.values(this.tunes).forEach(function (tune) {
      ...
      key: "saveTuneState",
      value: function () {
        var _saveTuneState = (0, _asyncToGenerator2.default)(
        /*#__PURE__*/
        _regenerator.default.mark(function _callee4(tune) {
          return _regenerator.default.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                ...
                case 2:
                  return _context4.abrupt("return", tune.save());
        ...
        return function saveTuneState(_x4) {
          return _saveTuneState.apply(this, arguments);
        };
      }()
    }, {
      key: "inputs",
      ...
      set: function set(element) {
        this.inputIndex = this.inputs.findIndex(function (input) {
    ...
    (0, _createClass2.default)(Core, [{
      ...
      set: function set(config) {
        ...
        if (_utils.default.isEmpty(this.config.data)) {
          ...
          if (_utils.default.isEmpty(this.config.tunes)) {
            this.config.tunes = {};
          }
        }
      }
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockManager, [{
      ...
      value: function composeBlock(toolName) {
        ...
        var block = new _block.default(toolName, toolInstance, toolClass, settings, this.config.tunes, this.Editor.API.methods);
      ...
      value: function setCurrentBlockByChildNode(childNode) {
        var caretPosition = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.Editor.Caret.positions.DEFAULT;
    ...
    function DragNDrop() {
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee(dropEvent) {
          var _this$Editor, BlockManager, Caret, Paste;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  try {
                    BlockManager.setCurrentBlockByChildNode(dropEvent.target, Caret.positions.END);
                  } catch (e) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js"), __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js"), __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"), __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/getPrototypeOf.js"), __webpack_require__(/*! @babel/runtime/helpers/inherits */ "./node_modules/@babel/runtime/helpers/inherits.js"), __webpack_require__(/*! ../utils */ "./src/components/utils.ts"), __webpack_require__(/*! ../__module */ "./src/components/__module.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _regenerator, _asyncToGenerator2, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _utils, _module) {
  "use strict";
    ...
    (0, _createClass2.default)(Saver, [{
      ...
      value: function makeOutput(allExtractedData) {
        ...
        allExtractedData.forEach(function (extraction) {
          ...
          if (!_utils.default.isEmpty(extraction.settings)) {
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.7.25");
