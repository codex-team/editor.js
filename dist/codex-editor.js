    ...
    (0, _createClass2.default)(Toolbar, [{
      ...
      value: function make() {
        ...
        this.Editor.Listeners.on(this.nodes.plusButton, 'mouseenter', function () {
          ...
          fragment.appendChild(_dom.default.make('p', _this2.Editor.Toolbox.CSS.tooltipShortcut, {
            textContent: '⇥ Tab'
          }));
        ...
        this.Editor.Listeners.on(this.nodes.plusButton, 'mousueleave', function () {
    ...
    (0, _createClass2.default)(Toolbox, [{
      ...
      value: function showTooltip(button, toolName) {
        ...
        if (shortcut) {
          ...
          shortcut = shortcut.replace(/shift/gi, '⇧').replace(/backspace/gi, '⌫').replace(/enter/gi, '⏎').replace(/up/gi, '↑').replace(/left/gi, '→').replace(/down/gi, '↓').replace(/right/gi, '←').replace(/escape/gi, '⎋').replace(/insert/gi, 'Ins').replace(/delete/gi, '␡');
          ...
          fragment.appendChild(_dom.default.make('p', this.CSS.tooltipShortcut, {
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.7.33");
