  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Toolbar, [{
      ...
      get: function get() {
        ...
        return {
          hide: function hide() {
            _this5.nodes.plusButton.classList.add(Toolbar.CSS.plusButtonHidden);

            _this5.nodes.wrapper.classList.remove(Toolbar.CSS.toolbarWithPlusButton);
          },
          show: function show() {
            ...
            _this5.nodes.wrapper.classList.add(Toolbar.CSS.toolbarWithPlusButton);
          }
        };
      }
      /**
