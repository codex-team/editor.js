...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js"), __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js"), __webpack_require__(/*! @babel/runtime/helpers/typeof */ "./node_modules/@babel/runtime/helpers/typeof.js"), __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! @babel/register */ "./node_modules/@babel/register/lib/index.js"), __webpack_require__(/*! components/polyfills */ "./src/components/polyfills.ts"), __webpack_require__(/*! ./components/core */ "./src/components/core.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _regenerator, _asyncToGenerator2, _typeof2, _classCallCheck2, _createClass2, _register, _polyfills, _core) {
  'use strict';
  /**
   * Apply polyfills
   */
  ...
  function () {
    ...
    function CodexEditor(configuration) {
      ...
      this.isReady = editor.isReady.then(function () {
        ...
        function _example() {
          _example = (0, _asyncToGenerator2.default)(
          /*#__PURE__*/
          _regenerator.default.mark(function _callee() {
            var start, i, res, data;
                  ...
                  case 0:
                    res = function _ref(n) {
                      ...
                      return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                          resolve();
                          console.log("res #".concat(id, " called after ").concat(n, " milliseconds"), Date.now() - start);
                        }, n);
                      });
                    };
                    ...
                    i = 0;
                    _context.next = 5;
                    return Promise.all([res(3000), res(2000), res(1000)]);
        ...
        function example1() {
          return _example2.apply(this, arguments);
        }

        function _example2() {
          _example2 = (0, _asyncToGenerator2.default)(
          /*#__PURE__*/
          _regenerator.default.mark(function _callee2() {
            var start, i, res, rej, data;
            return _regenerator.default.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    rej = function _ref3(n) {
                      var id = ++i;
                      return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                          reject();
                          console.log("rej #".concat(id, " called after ").concat(n, " milliseconds"), Date.now() - start);
                        }, n);
                      });
                    };

                    res = function _ref2(n) {
                      var id = ++i;
                      return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                          resolve();
                    ...
                    _context2.prev = 4;
                    _context2.next = 7;
                    return Promise.all([res(3000), res(2000), rej(1000)]);
