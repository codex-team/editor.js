  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockSelection, [{
      ...
      value: function prepare() {
        ...
        var overlay = _dom.default.make('div', 'codex-editor-overlay', {});

        var overlayContainer = _dom.default.make('div', 'codex-editor-overlay__container', {});

        var overlayRectangle = _dom.default.make('div', 'codex-editor-overlay__rectangle', {});

        var overlayTopScrollZone = _dom.default.make('div', 'codex-editor-overlay__scroll-zone--top', {});
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.7.15");
